...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MSNavigationController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Marshal/MSNavigationController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Marshal' => '717999274@qq.com' }
  s.source           = { :git => 'https://github.com/Marshal/MSNavigationController.git', :tag => s.version.to_s }
